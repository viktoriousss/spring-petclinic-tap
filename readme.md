...
```
tanzu apps workload create spring-petclinic-tap -f config/workload.yaml \
  --local-path . \
  --source-image <REPOSITORY-PREFIX>/spring-petclinic-tap-source \
  --type web
```
...
```
tanzu apps workload get spring-petclinic-tap
```
